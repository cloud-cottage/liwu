...
const expr=String.raw`(() => {
  ...
  return {
    ...
    userLike: objHooks.filter((h)=>('uid' in h.value)||('authUid' in h.value)||('phone' in h.value)||('storeId' in h.value)||('storeRole' in h.value)||('name' in h.value)).map((h)=>({idx:h.idx,value:sanitize(h.value)})).slice(0,20),
