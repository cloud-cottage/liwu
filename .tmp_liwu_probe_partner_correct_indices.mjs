...
const expr=String.raw`(() => {
  ...
  return {
    ...
    liveShopOrders: arr(13),
    liveShopOrderItems: arr(14),
    livePartnerOrders: arr(15),
    livePartnerSubOrders: arr(16),
    livePartnerUsers: arr(17),
    livePartnerBrands: arr(18),
    livePartnerBrandMembers: arr(19),
    livePartnerBrandInvites: arr(20),
    storeDraft: sanitize(valueAt(25)),
