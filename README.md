...
- Root `npm run build` assembles a deployable output from `apps/web`, including the partner management experience.
- `apps/web` is the canonical web client package and includes the `/partner` management surface plus `/admin` compatibility routing.
