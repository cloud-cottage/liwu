...
const challengesData = {
    1: { title: '七日静心', description: '连续7天完成每日冥想。在这个快节奏的世界里，给自己留出一点留白。冥想不仅是休息，更是对灵魂的洗礼。', reward: '50 荣誉点', type: 'Meditation', rules: ['每天至少完成一次10分钟以上的冥想', '不可中断，需连续7天'] },
    2: { title: '断舍离达人', description: '本周觉察5件断舍离物品。每一个留下的物品都应该是因为喜爱，而非习惯。通过整理空间，整理内心。', reward: '100 荣誉点', type: 'Declutter', rules: ['在"觉察"页面上传5件不再需要的物品', '物品估值不限'] },
    3: { title: '晨曦守望者', description: '连续3天在早晨8点前开启冥想。早起的阳光和清新的空气，是给早起者最好的礼物。', reward: '30 荣誉点', type: 'Meditation', rules: ['开启时间为本地时间 05:00 - 08:00', '连续3天'] },
};
