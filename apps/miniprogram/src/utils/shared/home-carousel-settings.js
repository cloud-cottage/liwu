...
const DEFAULT_BRAND_CAROUSEL_ITEMS = [
  {
    id: 'brand_slide_1',
...
const DEFAULT_BRAND_CAROUSEL_SETTINGS = {
  documentId: null,
...
const normalizeBrandCarouselSettings = (value = {}) => {
...
const toBrandCarouselSettingsPayload = (settings = {}) => {
