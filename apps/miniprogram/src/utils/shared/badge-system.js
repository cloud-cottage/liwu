...
const BADGE_PROFILE_COLLECTION = 'badge_profiles';

const BADGE_VISIBLE_GROUPS = {
  growth: 'growth',
  builder: 'builder'
};

const BADGE_INTERNAL_CATEGORIES = {
...
const BADGE_BONUS_TYPES = {
  percent: 'percent',
  fixed: 'fixed'
};

const BADGE_DIFFICULTIES = [
...
const BADGE_VISIBLE_GROUP_LABELS = {
  [BADGE_VISIBLE_GROUPS.growth]: '成长徽章',
  [BADGE_VISIBLE_GROUPS.builder]: '建设徽章'
};

const BADGE_INTERNAL_CATEGORY_LABELS = {
...
const BADGE_BONUS_ACTIVITY_MAP = {
...
const createDefaultBadgeSettings = () => ({
...
const normalizeBadgeLevel = (level = {}, fallbackId = '') => ({
...
const normalizeBadgeSettings = (value = {}) => {
...
const getBadgeDifficultyMeta = (difficultyKey = '') => (
...
const getBadgeSeriesProgressUnit = (series = {}) => (
...
module.exports = {
  ...
  normalizeBadgeLevel,
  normalizeBadgeSeries,
  normalizeBadgeSettings,
  flattenBadgeSeries,
  getBadgeDifficultyMeta,
  formatBadgeBonusText,
  getBadgeSeriesProgressUnit
}
