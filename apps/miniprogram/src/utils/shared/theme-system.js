const CLIENT_THEME_SETTINGS_KEY = 'client_theme_settings';
...
const DEFAULT_CLIENT_THEME_SETTINGS = {
  documentId: null,
  theme: 'IvoryAndSage',
  showDebugCard: true,
...
const normalizeClientThemeSettings = (value = {}) => ({
...
const toClientThemeSettingsPayload = (settings = {}) => {
