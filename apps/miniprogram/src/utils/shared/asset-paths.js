const miniProgramSharedAssetBase = '/assets/shared'

const tabbarIconKeys = {
...
const resolveMiniProgramIllustrationPath = (relativePath) => (
  `${miniProgramSharedAssetBase}/${relativePath}`
)

const resolveMiniProgramTabbarIconPath = (tabKey, active = false) => {
...
const resolveMiniProgramBrandPath = (assetKey) => {
...
const resolveMiniProgramIconPath = (iconKey) => {
...
const resolveShopLivingIllustrationPath = (index) => {
