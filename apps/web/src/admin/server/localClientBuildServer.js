...
const webPublicBuildDir = path.resolve(repoRoot, 'apps/web/public/client-builds')
const apkTargetPath = path.resolve(webPublicBuildDir, 'liwu-app-debug.apk')
...
const ensureApkCopied = () => {
  ...
  mkdirSync(webPublicBuildDir, { recursive: true })
