...
import { buildDefaultUserName, getUserInviteCode, getUserUid } from './cloudbase-user-identity.js'
import { normalizeRewardClaims, normalizeWealthHistory } from './cloudbase-wealth-snapshot.js'

export const normalizeCurrentUserProfile = (document = {}) => ({
