import { getDocumentId, isMissingCollectionResponse } from './cloudbase-document-helpers.js'
import { normalizeCurrentUserProfile } from './cloudbase-user-profile.js'
import {
...
export const mergeUserBundleIntoLegacyDocument = (identity = {}, parts = {}) => {
...
export const splitLegacyUserPatch = (patch = {}) => {
  const identityPatch = {}
  const profilePatch = {}
  const walletPatch = {}
...
export const createLoadMergedUserDocument = ({
  db,
  collections,
  getFirstDocument,
  isMissingCollectionIssue
...
export const createGetCurrentUserProfileBundle = (deps) => {
...
export const createGetAdminUserBundle = (deps) => createGetCurrentUserProfileBundle(deps)

export const createSaveCurrentUserProfileBundle = ({
  db,
  collections,
  getFirstDocument,
  isMissingCollectionIssue,
...
export const createSaveAdminUserBundle = (deps) => createSaveCurrentUserProfileBundle(deps)